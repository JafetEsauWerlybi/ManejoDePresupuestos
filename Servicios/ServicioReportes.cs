...
namespace ManejoDePresupuestos.Servicios
{
    ...
    public class ServicioReportes : IServicioReportes
    {
        ...
        public async Task<ReporteTransaccionesDetalladas> ObtenerTransaccionesDetalladas(int usuarioId, int mes, int año, dynamic ViewBag)
        {
        ...
        public async Task<ReporteTransaccionesDetalladas> ObtenerTransaccionesDetalladasPorCuenta
        ...
        private (DateTime fechaInicio, DateTime fechaFin) GenerarFechaInicioYFin(int mes, int año)
        {
            ...
            else { fechaInicio = new DateTime(año, mes, 1); }
